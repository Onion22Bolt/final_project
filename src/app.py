...
conn = psycopg2.connect(database="nftaggregator", user = "postgres", password = "onion", host = "127.0.0.1", port = "2020")
#Moralis
...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql+psycopg2://postgres:onion@127.0.0.1:2020/nftaggregator" #connection to database
